declare type SharedModuleMetadata = Partial<{
    /**
 ...
 */
export declare const sharedPluginModules: readonly ["@openshift-console/dynamic-plugin-sdk", "@openshift-console/dynamic-plugin-sdk-internal", "@patternfly/react-core", "@patternfly/react-table", "@patternfly/quickstarts", "react", "react-i18next", "react-router", "react-router-dom", "react-router-dom-v5-compat", "react-redux", "redux", "redux-thunk"];
export declare type SharedModuleNames = typeof sharedPluginModules[number];
/**
