...
export declare type DynamicModuleImportLoaderOptions = {
    dynamicModuleMaps: Record<string, DynamicModuleMap>;
    resourceMetadata: {
        jsx: boolean;
    };
};
export declare type DynamicModuleImportLoader = webpack.LoaderDefinitionFunction<DynamicModuleImportLoaderOptions>;
/**
