 ...
 */
export declare type ConsoleSupportedCustomProperties = Partial<{
 ...
 */
export declare type ConsolePluginBuildMetadata = PluginBuildMetadata & ConsoleSupportedCustomProperties;
/**
 * Standard Console dynamic plugin manifest format.
 */
export declare type StandardConsolePluginManifest = {
    customProperties?: {
 ...
 */
export declare type LegacyConsolePluginManifest = Pick<PluginManifest, 'name' | 'version' | 'dependencies' | 'extensions'> & ConsoleSupportedCustomProperties;
/**
 ...
 * the given plugin.
 */
export declare type AnyConsolePluginManifest = StandardConsolePluginManifest | LegacyConsolePluginManifest;
export declare const isStandardPluginManifest: (m: AnyConsolePluginManifest) => m is StandardConsolePluginManifest;
