...
const resolveEncodedCodeRefs = (extensions, entryModule, pluginID, errorCallback) => _.cloneDeep(extensions).map((e) => {
    (0, object_1.deepForOwn)(e.properties, exports.isEncodedCodeRef, (ref, key, obj) => {
        const loader = (0, exports.applyCodeRefSymbol)(() => __awaiter(void 0, void 0, void 0, function* () { return (0, exports.loadReferencedObject)(ref, entryModule, pluginID, errorCallback); }));
...
const resolveExtension = (extension) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, object_1.deepForOwn)(extension.properties, exports.isExecutableCodeRef, (ref, key, obj) => {
        ...
        valueResolutions.push(ref()
            ...
            .catch((e) => {
            (0, exports.setCodeRefError)(ref, e !== null && e !== void 0 ? e : true);
            return e;
        }));
    });
    yield (0, promise_1.settleAllPromises)(valueResolutions);
    return extension;
});
