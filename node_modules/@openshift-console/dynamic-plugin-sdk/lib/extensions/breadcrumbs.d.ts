...
export declare type DetailsPageBreadCrumbsHook = (kind: K8sModel, urlMatch: any) => {
    name: string;
    path: string;
}[];
export declare type DetailPageBreadCrumbs = ExtensionDeclaration<'dev-console.detailsPage/breadcrumbs', {
    /**
