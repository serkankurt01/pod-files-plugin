...
export declare const isRoutePage: (e: Extension) => e is RoutePage;
export declare const isStandaloneRoutePage: (e: Extension) => e is StandaloneRoutePage;
export declare const isResourceListPage: (e: Extension) => e is ResourceListPage;
export declare const isResourceDetailsPage: (e: Extension) => e is ResourceDetailsPage;
/** @deprecated - use `console.tab/horizontalNav` */
export declare const isResourceTabPage: (e: Extension) => e is ResourceTabPage;
export {};
