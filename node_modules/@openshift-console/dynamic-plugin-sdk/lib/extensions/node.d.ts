...
export declare type IsNodeStatusActive<T extends ResourcesObject> = (node: NodeKind, resources: WatchK8sResults<T>) => boolean;
export declare type NodePopoverContentProps<T extends ResourcesObject> = {
    node: NodeKind;
    resources: WatchK8sResults<T>;
};
/** This extension can be used to add additional states to Node resource. */
export declare type NodeStatus<T extends ResourcesObject = ResourcesObject> = ExtensionDeclaration<'console.node/status', {
...
export declare const isNodeStatus: (e: Extension) => e is NodeStatus<ResourcesObject>;
