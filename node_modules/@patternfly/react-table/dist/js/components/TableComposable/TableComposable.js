...
const TableComposableBase = (_a) => {
    ...
    React.useEffect(() => {
        ...
        if (tableRef && tableRef.current && tableRef.current.classList.contains('pf-m-tree-view')) {
            ...
            tbody && (0, helpers_1.setTabIndex)(Array.from(tbody.querySelectorAll('button, a, input')));
        }
    ...
    const ouiaProps = (0, helpers_1.useOUIAProps)('Table', ouiaId, ouiaSafe);
    ...
    const handleKeys = (event) => {
        ...
        (0, helpers_1.handleArrows)(event, rows, (element) => element === activeElement.closest('tr'), getFocusableElement, ['button', 'input', 'a'], undefined, false, true, false);
    };
