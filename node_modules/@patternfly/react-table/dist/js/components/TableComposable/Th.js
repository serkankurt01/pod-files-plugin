...
const ThBase = (_a) => {
    ...
    if (sort) {
        if (sort.isFavorites) {
            sortParams = (0, sortable_1.sortableFavorites)({
            ...
            sortParams = (0, sortable_1.sortable)(children, {
                columnIndex: sort.columnIndex,
                column: {
                    extraParams: {
                        sortBy: sort.sortBy,
    ...
    const collapseParams = collapse
        ? (0, collapsible_1.collapsible)(children, {
            column: {
                extraParams: {
    ...
    let infoParams = null;
    if (infoProps) {
        infoParams = (0, info_1.info)(infoProps)(transformedChildren);
