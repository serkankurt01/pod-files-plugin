...
class Table extends React.Component {
    constructor() {
        super(...arguments);
        this.state = {
            ouiaStateId: (0, helpers_1.getDefaultOUIAId)(Table.displayName)
        };
    ...
    render() {
        ...
        const headerData = (0, headerUtils_1.calculateColumns)(cells, {
            sortBy,
            onSort,
            onSelect,
...
Table.defaultProps = {
    ...
    dropdownPosition: Dropdown_1.DropdownPosition.right,
    dropdownDirection: Dropdown_1.DropdownDirection.down,
