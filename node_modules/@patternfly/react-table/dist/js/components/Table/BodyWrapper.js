...
const BodyWrapper = (_a) => {
    ...
    if (mappedRows && mappedRows.some(row => row.hasOwnProperty('parent'))) {
        return (React.createElement(React.Fragment, null, (0, headerUtils_1.mapOpenedRows)(mappedRows, props.children).map((oneRow, key) => (React.createElement(Tbody_1.Tbody, Object.assign({}, props, { isExpanded: oneRow.isOpen, key: `tbody-${key}`, ref: tbodyRef }), oneRow.rows)))));
    }
