...
const Dropdown_2 = require('@patternfly/react-core/dist/js/components/Dropdown');
const Dropdown_3 = require('@patternfly/react-core/dist/js/components/Dropdown');
const Button_1 = require('@patternfly/react-core/dist/js/components/Button');
const Dropdown_4 = require('@patternfly/react-core/dist/js/components/Dropdown');
class ActionsColumn extends React.Component {
    ...
    render() {
        ...
        const actionsToggleClone = actionsToggle ? (actionsToggle({ onToggle: this.onToggle, isOpen, isDisabled })) : (React.createElement(Dropdown_1.KebabToggle, { isDisabled: isDisabled, onToggle: this.onToggle }));
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement(Dropdown_1.Dropdown, Object.assign({ toggle: actionsToggleClone, position: dropdownPosition, direction: dropdownDirection, menuAppendTo: menuAppendTo, isOpen: isOpen, dropdownItems: items
                    .filter(item => !item.isOutsideDropdown)
                    .map((_a, key) => {
                    var { title, itemKey, onClick, isSeparator } = _a, props = tslib_1.__rest(_a, ["title", "itemKey", "onClick", "isSeparator"]);
                    return isSeparator ? (React.createElement(Dropdown_3.DropdownSeparator, Object.assign({}, props, { key: itemKey || key, "data-key": itemKey || key }))) : (React.createElement(Dropdown_2.DropdownItem, Object.assign({ component: "button", onClick: event => {
                            this.onClick(event, onClick);
                            this.onToggle(!isOpen);
...
ActionsColumn.defaultProps = {
    children: null,
    items: [],
    dropdownPosition: Dropdown_4.DropdownPosition.right,
    dropdownDirection: Dropdown_4.DropdownDirection.down,
    menuAppendTo: 'inline',
    rowData: {},
    extraData: {}
};
